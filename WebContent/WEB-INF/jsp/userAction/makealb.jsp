	...
	<script>
		...
		$(function(){
			   ...
			   $("#submitbtn").click(function(){
				   console.log("完成制作！");
				   var data =[];
				   var objDom0 = document.getElementById("itemContainer"); 
				   console.log("string之前"+objDom0)
				   var bgps = objDom0.getElementsByClassName("bgps");
				   json = JSON.stringify(objDom0);

				   console.log("string之后"+json)
				  
				  
				   for(var i =0;i<bgps.length;i++){//遍历所有模板页
					   var draggable = bgps[i].getElementsByClassName("draggable");
					   var photos=[];
				   ...
				   console.log("data："+data);
			        ...
			        $.ajax({
	                    type : "post",
	                    url : 'user_beAlbum.action?albumId=${albumId}',//触发的action
	                    async:true,//非异步传输
